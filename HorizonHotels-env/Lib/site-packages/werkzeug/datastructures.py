...
class Authorization(ImmutableDictMixin, dict):
    ...
    @property
    def ***REMOVED***(self):
        """When the authentication type is basic this is the ***REMOVED***
    ...
    def response(self):
        ...
        proves that the user knows a ***REMOVED***.  Digest auth only.
        """
    ...
    def to_header(self):
        ...
        if self.type == "basic":
            value = base64.b64encode(
                f"{self.username}:{self.***REMOVED***}".encode()
            ).decode("utf8")
...
class WWWAuthenticate(UpdateDictMixin, dict):
    ...
    realm = auth_property(
        ...
        username and ***REMOVED*** to use. This string should contain at
