...
class Subversion(VersionControl):
    ...
    def get_netloc_and_auth(cls, netloc, scheme):
        ...
        --username and --***REMOVED*** options instead of via the URL.
        """
        if scheme == 'ssh':
            # The --username and --***REMOVED*** options can't be used for
    ...
    def _get_svn_url_rev(cls, location):
        ...
        if (data.startswith('8') or
            ...
            try:
                ...
                # is being used to prompt for ***REMOVED***s, because ***REMOVED***s
    ...
    def get_remote_call_options(self):
        ...
        # the user can be prompted for a ***REMOVED***, if required.
