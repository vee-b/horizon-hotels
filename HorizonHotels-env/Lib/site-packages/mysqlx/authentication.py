...
def xor_string(hash1, hash2, hash_size):
    """Encrypt/Decrypt function used for ***REMOVED*** encryption in
...
class BaseAuthPlugin(object):
    ...
    def __init__(self, username=None, ***REMOVED***=None):
        self._username = username
        self._***REMOVED*** = ***REMOVED***
...
class MySQL41AuthPlugin(BaseAuthPlugin):
    ...
    def auth_data(self, data):
        ...
        """
        if self._***REMOVED***:
            ***REMOVED*** = self._***REMOVED***.encode("utf-8") \
                if isinstance(self._***REMOVED***, UNICODE_TYPES) else self._***REMOVED***
            hash1 = hashlib.sha1(***REMOVED***).digest()
...
class PlainAuthPlugin(BaseAuthPlugin):
    ...
    def auth_data(self):
        ...
        """
        ***REMOVED*** = self._***REMOVED***.encode("utf-8") \
            if isinstance(self._***REMOVED***, UNICODE_TYPES) and not PY3 \
               else self._***REMOVED***
        return "\0{0}\0{1}".format(self._username, ***REMOVED***)
...
class Sha256MemoryAuthPlugin(BaseAuthPlugin):
    ...
    def auth_data(self, data):
        ...
        ***REMOVED*** = self._***REMOVED***.encode("utf-8") \
            if isinstance(self._***REMOVED***, UNICODE_TYPES) else self._***REMOVED***
        hash1 = hashlib.sha256(***REMOVED***).digest()
