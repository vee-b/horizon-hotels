...
_SSL_OPTS = ["ssl-cert", "ssl-ca", "ssl-key", "ssl-crl", "tls-versions",
             "tls-ciphersuites"]
_SESS_OPTS = _SSL_OPTS + ["user", "***REMOVED***", "schema", "host", "port",
...
def _parse_connection_uri(uri):
    ...
    user, ***REMOVED*** = userinfo.split(":", 1)
    settings["user"], settings["***REMOVED***"] = unquote(user), unquote(***REMOVED***)
    ...
    invalid_options = ("user", "***REMOVED***", "dns-srv")
        ...
        connection_string: A string or a dict type object to indicate the \
            ...
            And the dictionary::
                ...
                cnx_dict = {
                    ...
                    '***REMOVED***': 'The ***REMOVED*** for the given user account',
