...
class MySQLConnectionAbstract(object):
    ...
    def config(self, **kwargs):
        ...
        if 'user' in config or '***REMOVED***' in config:
            try:
                user = config['user']
                del config['user']
            except KeyError:
            ...
            try:
                ...
                ***REMOVED*** = self._***REMOVED***
            self.set_login(user, ***REMOVED***)
    ...
    def set_login(self, username=None, ***REMOVED***=None):
        """Set login information for MySQL

        Set the username and/or ***REMOVED*** for the user connecting to
        the MySQL Server.
        """
    ...
    def connect(self, **kwargs):
        ...
        # when user's ***REMOVED*** has been expired.
