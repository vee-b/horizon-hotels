...
class MySQLProtocol(object):
    ...
    def _auth_response(self, client_flags, username, ***REMOVED***, database,
    ...
    def make_auth(self, handshake, username=None, ***REMOVED***=None, database=None,
        ...
        packet += self._auth_response(client_flags, username, ***REMOVED***,
                                      database,
                                      auth_plugin,
    ...
    def make_change_user(self, handshake, username=None, ***REMOVED***=None,
    ...
    def parse_handshake(self, packet):
        ...
        if capabilities & ClientFlag.PLUGIN_AUTH:
            ...
            res['auth_plugin'] = 'mysql_native_***REMOVED***'
