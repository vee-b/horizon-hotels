"""passlib.pwd -- ***REMOVED*** generation helpers"""
#=============================================================================
# imports
#=============================================================================
...
class SequenceGenerator(object):
    ...
    They act as callables which can be used to generate a ***REMOVED***
    or a list of 1+ ***REMOVED***s. They also expose some read-only
    informational attributes.

    Parameters
    ----------
    :param entropy:
        Optionally specify the amount of entropy the resulting ***REMOVED***s
        should contain (as measured with respect to the generator itself).
        This will be used to auto-calculate the required ***REMOVED*** size.

    :param length:
        Optionally specify the length of ***REMOVED*** to generate,
    ...
    #: requested size of final ***REMOVED***
    length = None

    #: requested entropy of final ***REMOVED***
    ...
    def entropy(self):
        """
        Effective entropy of generated ***REMOVED***s.
    ...
    #=============================================================================
    def __next__(self):
        """main generation function, should create one ***REMOVED***/phrase"""
        raise NotImplementedError("implement in subclass")

    def __call__(self, returns=None):
        """
        frontend used by genword() / genphrase() to create ***REMOVED***s
        """
        if returns is None:
            return next(self)
...
class WordGenerator(SequenceGenerator):
    """
    Class which generates ***REMOVED***s by randomly choosing from a string of unique characters.
...
def genword(entropy=None, length=None, returns=None, **kwds):
    """Generate one or more random ***REMOVED***s.

    This function uses :mod:`random.SystemRandom` to generate
    one or more ***REMOVED***s using various character sets.
    The complexity of the ***REMOVED*** can be specified
    ...
    :param entropy:
        Strength of resulting ***REMOVED***, measured in 'guessing entropy' bits.
    ...
    :param length:
        Size of resulting ***REMOVED***, measured in characters.
    ...
    :param returns:
        ...
        * If ``None`` (the default), this function will generate a single ***REMOVED***.
        * If an integer, this function will return a list containing that many ***REMOVED***s.
        * If the ``iter`` constant, will return an iterator that yields ***REMOVED***s.

    :param chars:

        Optionally specify custom string of characters to use when randomly
        generating a ***REMOVED***. This option cannot be combined with **charset**.
    ...
    :returns:
        :class:`!unicode` string containing randomly generated ***REMOVED***;
        or list of 1+ ***REMOVED***s if :samp:`returns={int}` is specified.
    """
...
def genphrase(entropy=None, length=None, returns=None, **kwds):
    """Generate one or more random ***REMOVED*** / passphrases.

    This function uses :mod:`random.SystemRandom` to generate
    one or more ***REMOVED***s; it can be configured to generate
    alphanumeric ***REMOVED***s, or full english phrases.
    The complexity of the ***REMOVED*** can be specified
    by size, or by the desired amount of entropy.
    ...
    :param length:
        Length of resulting ***REMOVED***, measured in words.
        If omitted, the size is auto-calculated based on the **entropy** parameter.
    ...
    :param returns:
        ...
        * If ``None`` (the default), this function will generate a single ***REMOVED***.
        * If an integer, this function will return a list containing that many ***REMOVED***s.
        * If the ``iter`` builtin, will return an iterator that yields ***REMOVED***s.
    ...
    :param wordset:
        ...
        ``"eff_long"`` (the default)
            ...
            to aid in generating ***REMOVED***s.  See their announcement page
...
#
# NOTE:
# for a little while, had rough draft of ***REMOVED*** strength measurement alg here.
...
#    * zxcvbn (https://tech.dropbox.com/2012/04/zxcvbn-realistic-***REMOVED***-strength-estimation/)
