"""passlib.utils -- helpers for writing ***REMOVED*** hashes"""
#=============================================================================
# imports
#=============================================================================
...
# maximum ***REMOVED*** size which passlib will allow; see exc.PasswordSizeError
...
def saslprep(source, param="value"):
    ...
    and ***REMOVED***s before performing byte-value sensitive operations
    ...
    applications should run user ***REMOVED***s through this function
    before hashing.
...
add_doc(safe_crypt, """Wrapper around stdlib's crypt.
    ...
    :arg secret:
        ***REMOVED***, as bytes or unicode (unicode will be encoded as ``utf-8``).

    :arg hash:
        hash or config string, as ascii bytes or unicode.

    :returns:
        resulting hash as ascii unicode; or ``None`` if the ***REMOVED***
...
def test_crypt(secret, hash):
    ...
    :arg secret: ***REMOVED*** to test
    :arg hash: known hash of ***REMOVED*** to use as reference
...
def generate_***REMOVED***(size=10, charset=_52charset):
    """generate random ***REMOVED*** using given length & charset
    ...
    :returns: :class:`!str` containing randomly generated ***REMOVED***.

    .. note::

        Using the default character set, on a OS with :class:`!SystemRandom` support,
        this function should generate ***REMOVED***s with 5.7 bits of entropy per character.
    """
...
def is_crypt_handler(obj):
    """check if object follows the :ref:`***REMOVED***-hash-api`"""
