"""passlib.crypto.digest -- crytographic helpers used by the ***REMOVED*** hashes in passlib
...
def pbkdf1(digest, secret, salt, rounds, keylen=None):
    """pkcs#5 ***REMOVED***-based key derivation v1.5
...
def pbkdf2_hmac(digest, secret, salt, rounds, keylen=None):
    """pkcs#5 ***REMOVED***-based key derivation v2.0 using HMAC + arbitrary digest.
