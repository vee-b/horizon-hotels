"""passlib.registry - registry for ***REMOVED*** hash handlers"""
#=============================================================================
# imports
#=============================================================================
# core
...
class _PasslibRegistryProxy(object):
    ...
    the requested ***REMOVED*** hash algorithm from wherever it has been stored.
    ...
    def __getattr__(self, attr):
        ...
        if handler:
            ...
            raise AttributeError("unknown ***REMOVED*** hash: %r" % (attr,))
...
def register_crypt_handler_path(name, path):
    ...
    the specified module path should contain a ***REMOVED*** hash handler
...
def register_crypt_handler(handler, force=False, _attr=None):
    ...
    :arg handler: the ***REMOVED*** hash handler to register
    ...
    if not is_crypt_handler(handler):
        raise ExpectedTypeError(handler, "***REMOVED*** hash handler", "handler")
    if not handler:
...
def get_crypt_handler(name, default=_UNSET):
    """return handler for specified ***REMOVED*** hash scheme.
