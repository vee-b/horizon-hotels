"""passlib.handlers.scrypt -- scrypt ***REMOVED*** hash"""
#=============================================================================
# imports
#=============================================================================
...
class scrypt(uh.ParallelismMixin, uh.HasRounds, uh.HasRawSalt, uh.HasRawChecksum, uh.HasManyIdents,
             uh.GenericHandler):
    """This class implements an SCrypt-based ***REMOVED*** [#scrypt-home]_ hash, and follows the :ref:`***REMOVED***-hash-api`.
    ...
    :param rounds:
        ...
        .. warning::
            ...
            will increase both the time *and memory* required to hash a ***REMOVED***.
    ...
    #       but a 256-bit digest is more than sufficient for ***REMOVED*** hashing.
