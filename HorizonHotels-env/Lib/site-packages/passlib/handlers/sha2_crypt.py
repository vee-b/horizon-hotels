...
def _raw_sha2_crypt(pwd, salt, rounds, use_512=False):
    ...
    :arg pwd: ***REMOVED*** chars/bytes to hash
    ...
    #       with the size of the ***REMOVED***, making it vulnerable to a DOS from
    ...
    #       O(pwd_len)-memory algorithm for ***REMOVED***s that are much larger 
    #       than average, and 2) Passlib enforces a library-wide max limit on
    #       the size of ***REMOVED***s it will allow, to prevent this algorithm and 
    ...
    #===================================================================
    # digest P from ***REMOVED*** - used instead of ***REMOVED*** itself
    #                          when calculating digest C.
    #===================================================================
    if pwd_len < 96:
        # this method is faster under python, but uses O(pwd_len**2) memory;
        # so we don't use it for larger ***REMOVED***s to avoid a potential DOS.
...
class sha256_crypt(_SHA2_Common):
    """This class implements the SHA256-Crypt ***REMOVED*** hash, and follows the :ref:`***REMOVED***-hash-api`.
...
class sha512_crypt(_SHA2_Common):
    """This class implements the SHA512-Crypt ***REMOVED*** hash, and follows the :ref:`***REMOVED***-hash-api`.
