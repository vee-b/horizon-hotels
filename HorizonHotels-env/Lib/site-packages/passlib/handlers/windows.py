...
class lmhash(uh.TruncateMixin, uh.HasEncodingContext, uh.StaticHandler):
    """This class implements the Lan Manager Password hash, and follows the :ref:`***REMOVED***-hash-api`.
    ...
    :param bool truncate_error:
        By default, this will silently truncate ***REMOVED***s larger than 14 bytes.
    ...
    def raw(cls, secret, encoding=None):
        """encode ***REMOVED*** using LANMAN hash algorithm.
...
class nthash(uh.StaticHandler):
    """This class implements the NT Password hash, and follows the :ref:`***REMOVED***-hash-api`.
    ...
    @classmethod
    def raw(cls, secret):
        """encode ***REMOVED*** using MD4-based NTHASH algorithm
...
class msdcc(uh.HasUserContext, uh.StaticHandler):
    """This class implements Microsoft's Domain Cached Credentials ***REMOVED*** hash,
    and follows the :ref:`***REMOVED***-hash-api`.
    ...
    def raw(cls, secret, user):
        """encode ***REMOVED*** using mscash v1 algorithm
...
class msdcc2(uh.HasUserContext, uh.StaticHandler):
    ...
    ***REMOVED*** hash, and follows the :ref:`***REMOVED***-hash-api`.
    ...
    @classmethod
    def raw(cls, secret, user):
        """encode ***REMOVED*** using msdcc v2 algorithm
