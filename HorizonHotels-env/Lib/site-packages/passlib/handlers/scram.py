...
class scram(uh.HasRounds, uh.HasRawSalt, uh.HasRawChecksum, uh.GenericHandler):
    """This class provides a format for storing SCRAM ***REMOVED***s, and follows
    the :ref:`***REMOVED***-hash-api`.
    ...
    In addition to the standard :ref:`***REMOVED***-hash-api` methods,
    ...
    def extract_digest_info(cls, hash, alg):
        ...
        :returns:
            ...
            SCRAM's :func:`Hi` function for the stored ***REMOVED***,
    ...
    @classmethod
    def derive_digest(cls, ***REMOVED***, salt, rounds, alg):
        """helper to create SaltedPassword digest for SCRAM.

        This performs the step in the SCRAM protocol described as::

            SaltedPassword  := Hi(Normalize(***REMOVED***), salt, i)

        :type ***REMOVED***: unicode or utf-8 bytes
        :arg ***REMOVED***: ***REMOVED*** to run through digest
...
##
##    takes in alg, salt, rounds, and a digest or ***REMOVED***.
##
...
##
##    def __init__(self, alg, salt, rounds, digest=None, ***REMOVED***=None):
##        self.alg = norm_hash_name(alg)
##        self.salt = salt
##        self.rounds = rounds
##        self.***REMOVED*** = ***REMOVED***
##        if ***REMOVED***:
##            data = scram.derive_digest(***REMOVED***, salt, rounds, alg)
##            if digest and data != digest:
##                raise ValueError("***REMOVED*** doesn't match digest")
##            else:
##                digest = data
##        elif not digest:
##            raise TypeError("must provide ***REMOVED*** or digest")
##        self.digest = digest
##
##    #=========================================================
##    # frontend methods
