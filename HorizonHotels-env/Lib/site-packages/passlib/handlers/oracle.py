...
class oracle10(uh.HasUserContext, uh.StaticHandler):
    """This class implements the ***REMOVED*** hash used by Oracle up to version 10g, and follows the :ref:`***REMOVED***-hash-api`.
    ...
    :type user: str
    :param user: name of oracle user account this ***REMOVED*** is associated with.
    """
    #===================================================================
...
class oracle11(uh.HasSalt, uh.GenericHandler):
    """This class implements the Oracle11g ***REMOVED*** hash, and follows the :ref:`***REMOVED***-hash-api`.
