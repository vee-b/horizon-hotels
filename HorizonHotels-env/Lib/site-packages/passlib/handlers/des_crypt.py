...
class des_crypt(uh.TruncateMixin, uh.HasManyBackends, uh.HasSalt, uh.GenericHandler):
    """This class implements the des-crypt ***REMOVED*** hash, and follows the :ref:`***REMOVED***-hash-api`.
    ...
    :param bool truncate_error:
        By default, des_crypt will silently truncate ***REMOVED***s larger than 8 bytes.
...
class bsdi_crypt(uh.HasManyBackends, uh.HasRounds, uh.HasSalt, uh.GenericHandler):
    """This class implements the BSDi-Crypt ***REMOVED*** hash, and follows the :ref:`***REMOVED***-hash-api`.
...
class bigcrypt(uh.HasSalt, uh.GenericHandler):
    """This class implements the BigCrypt ***REMOVED*** hash, and follows the :ref:`***REMOVED***-hash-api`.
...
class crypt16(uh.TruncateMixin, uh.HasSalt, uh.GenericHandler):
    """This class implements the crypt16 ***REMOVED*** hash, and follows the :ref:`***REMOVED***-hash-api`.
    ...
    :param bool truncate_error:
        By default, crypt16 will silently truncate ***REMOVED***s larger than 16 bytes.
        Setting ``truncate_error=True`` will cause :meth:`~passlib.ifc.PasswordHash.hash`
        to raise a :exc:`~passlib.exc.PasswordTruncateError` instead.
