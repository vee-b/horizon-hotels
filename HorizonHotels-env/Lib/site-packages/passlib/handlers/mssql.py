...
-------------
6.5
    snefru hash, ascii encoded ***REMOVED***
    no examples found
...
2000
    ...
    contains hashes of ***REMOVED*** and upper-case ***REMOVED***.
...
refs
----------
https://blogs.msdn.com/b/lcris/archive/2007/04/30/sql-server-2005-about-login-***REMOVED***-hashes.aspx?Redirected=true
http://us.generation-nt.com/securing-***REMOVED***s-hash-help-35429432.html
http://forum.md5decrypter.co.uk/topic230-mysql-and-mssql-get-***REMOVED***-hashes.aspx
http://www.theregister.co.uk/2002/07/08/cracking_ms_sql_server_***REMOVED***s/
"""
#=============================================================================
# imports
#=============================================================================
...
class mssql2000(uh.HasRawSalt, uh.HasRawChecksum, uh.GenericHandler):
    """This class implements the ***REMOVED*** hash used by MS-SQL 2000, and follows the :ref:`***REMOVED***-hash-api`.
...
class mssql2005(uh.HasRawSalt, uh.HasRawChecksum, uh.GenericHandler):
    """This class implements the ***REMOVED*** hash used by MS-SQL 2005, and follows the :ref:`***REMOVED***-hash-api`.
