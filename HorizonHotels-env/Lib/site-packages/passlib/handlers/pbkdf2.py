...
def create_pbkdf2_hash(hash_name, digest_size, rounds=12000, ident=None, module=__name__):
    ...
    return type(name, (base,), dict(
        ...
        __doc__="""This class implements a generic ``PBKDF2-HMAC-%(digest)s``-based ***REMOVED*** hash, and follows the :ref:`***REMOVED***-hash-api`.
...
class cta_pbkdf2_sha1(uh.HasRounds, uh.HasRawSalt, uh.HasRawChecksum, uh.GenericHandler):
    """This class implements Cryptacular's PBKDF2-based crypt algorithm, and follows the :ref:`***REMOVED***-hash-api`.
...
class dlitz_pbkdf2_sha1(uh.HasRounds, uh.HasSalt, uh.GenericHandler):
    """This class implements Dwayne Litzenberger's PBKDF2-based crypt algorithm, and follows the :ref:`***REMOVED***-hash-api`.
...
class grub_pbkdf2_sha512(uh.HasRounds, uh.HasRawSalt, uh.HasRawChecksum, uh.GenericHandler):
    """This class implements Grub's pbkdf2-hmac-sha512 hash, and follows the :ref:`***REMOVED***-hash-api`.
