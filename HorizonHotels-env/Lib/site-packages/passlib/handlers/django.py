"""passlib.handlers.django- Django ***REMOVED*** hash support"""
#=============================================================================
# imports
#=============================================================================
# core
...
class django_salted_sha1(DjangoSaltedHash):
    """This class implements Django's Salted SHA1 hash, and follows the :ref:`***REMOVED***-hash-api`.
...
class django_salted_md5(DjangoSaltedHash):
    """This class implements Django's Salted MD5 hash, and follows the :ref:`***REMOVED***-hash-api`.
...
django_bcrypt = uh.PrefixWrapper("django_bcrypt", bcrypt,
    ...
    doc="""This class implements Django 1.4's BCrypt wrapper, and follows the :ref:`***REMOVED***-hash-api`.
...
class django_bcrypt_sha256(_wrapped_bcrypt):
    """This class implements Django 1.6's Bcrypt+SHA256 hash, and follows the :ref:`***REMOVED***-hash-api`.
...
class django_pbkdf2_sha256(DjangoVariableHash):
    """This class implements Django's PBKDF2-HMAC-SHA256 hash, and follows the :ref:`***REMOVED***-hash-api`.
...
class django_pbkdf2_sha1(django_pbkdf2_sha256):
    """This class implements Django's PBKDF2-HMAC-SHA1 hash, and follows the :ref:`***REMOVED***-hash-api`.
...
django_argon2 = uh.PrefixWrapper(
    ...
    # NOTE: this docstring is duplicated in the docs, since sphinx
    # seems to be having trouble reading it via autodata::
    doc="""This class implements Django 1.10's Argon2 wrapper, and follows the :ref:`***REMOVED***-hash-api`.
...
class django_des_crypt(uh.TruncateMixin, uh.HasSalt, uh.GenericHandler):
    """This class implements Django's :class:`des_crypt` wrapper, and follows the :ref:`***REMOVED***-hash-api`.
    ...
    :param bool truncate_error:
        By default, django_des_crypt will silently truncate ***REMOVED***s larger than 8 bytes.
...
class django_disabled(uh.ifc.DisabledHash, uh.StaticHandler):
    """This class provides disabled ***REMOVED*** behavior for Django, and follows the :ref:`***REMOVED***-hash-api`.

    This class does not implement a hash, but instead
    claims the special hash string ``"!"`` which Django uses
    to indicate an account's ***REMOVED*** has been disabled.

    * newly encrypted ***REMOVED***s will hash to ``"!"``.
    * it rejects all ***REMOVED***s.

    .. note::

        Django 1.6 prepends a randomly generated 40-char alphanumeric string
        to each unusuable ***REMOVED***. This class recognizes such strings,
