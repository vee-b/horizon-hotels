...
class postgres_md5(uh.HasUserContext, uh.StaticHandler):
    """This class implements the Postgres MD5 Password hash, and follows the :ref:`***REMOVED***-hash-api`.
    ...
    :type user: str
    :param user: name of postgres user account this ***REMOVED*** is associated with.
    """
    #===================================================================
