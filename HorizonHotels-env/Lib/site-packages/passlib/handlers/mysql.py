...
MySQL 3.2.3 / OLD_PASSWORD()
    ...
    This algorithm is known to be very insecure, and should only be used to verify existing ***REMOVED*** hashes.
...
MySQL 4.1.1 / NEW PASSWORD
    ...
    It should only be used when dealing with mysql ***REMOVED***s,
    for all other purposes, you should use a salted hash function.

    Description taken from http://dev.mysql.com/doc/refman/6.0/en/***REMOVED***-hashing.html
"""
#=============================================================================
# imports
#=============================================================================
...
class mysql323(uh.StaticHandler):
    """This class implements the MySQL 3.2.3 ***REMOVED*** hash, and follows the :ref:`***REMOVED***-hash-api`.
    ...
    def _calc_checksum(self, secret):
        # FIXME: no idea if mysql has a policy about handling unicode ***REMOVED***s
...
class mysql41(uh.StaticHandler):
    """This class implements the MySQL 4.1 ***REMOVED*** hash, and follows the :ref:`***REMOVED***-hash-api`.
