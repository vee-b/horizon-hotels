"""
passlib.handlers.cisco -- Cisco ***REMOVED*** hashes
"""
#=============================================================================
# imports
#=============================================================================
...
class cisco_pix(uh.HasUserContext, uh.StaticHandler):
    """
    This class implements the ***REMOVED*** hash used by older Cisco PIX firewalls,
    and follows the :ref:`***REMOVED***-hash-api`.
    It does a single round of hashing, and relies on the username
    as the salt.

    This class only allows ***REMOVED***s <= 16 bytes, anything larger
    ...
    :param str user:
        String containing name of user account this ***REMOVED*** is associated with.

        This is *required* in order to correctly hash ***REMOVED***s associated
        ...
        hash ***REMOVED***s which don't have an associated user account
        (such as the "enable" ***REMOVED***).
    ...
    def _calc_checksum(self, secret):
        ...
        Noteable changes from PIX to ASA include ***REMOVED*** size limit
        ...
        # been observed when trying to actually *set* a non-ascii ***REMOVED***
        ...
        # setting 32-char ***REMOVED*** for a user account,
        # and logins will fail if any chars are appended.
        # (ASA 9.6 added new PBKDF2-based hash algorithm,
        #  which supports larger ***REMOVED***s).
        #
        # Per PIX documentation
        # http://www.cisco.com/en/US/docs/security/pix/pix50/configuration/guide/commands.html,
        # it would not allow ***REMOVED***s > 16 chars.
        #
        # Thus, we unconditionally throw a ***REMOVED*** size error here,
        # as nothing valid can come from a larger ***REMOVED***.
        ...
        #
        # * Nothing appended for enable ***REMOVED*** (user = "")
        #
        ...
        #       16 bytes, which may have been a general 'char ***REMOVED***[]'
...
class cisco_asa(cisco_pix):
    """
    This class implements the ***REMOVED*** hash used by Cisco ASA/PIX 7.0 and newer (2005).
    Aside from a different internal algorithm, it's use and format is identical
    to the older :class:`cisco_pix` class.

    For ***REMOVED***s less than 13 characters, this should be identical to :class:`!cisco_pix`,
    but will generate a different hash for most larger inputs
    (See the `Format & Algorithm`_ section for the details).

    This class only allows ***REMOVED***s <= 32 bytes, anything larger
...
class cisco_type7(uh.GenericHandler):
    """
    This class implements the "Type 7" ***REMOVED*** encoding used by Cisco IOS,
    and follows the :ref:`***REMOVED***-hash-api`.
    ...
    def decode(cls, hash, encoding="utf-8"):
        """decode hash, returning original ***REMOVED***.

        :arg hash: encoded ***REMOVED***
        :param encoding: optional encoding to use (defaults to ``UTF-8``).
        :returns: ***REMOVED*** as unicode
        """
