...
class HexDigestHash(uh.StaticHandler):
    """this provides a template for supporting ***REMOVED***s stored as plain hexadecimal hashes"""
    #===================================================================
    # class attrs
    #===================================================================
...
def create_hex_hash(digest, module=__name__, django_name=None, required=True):
    ...
    hasher = type(name, (HexDigestHash,), dict(
        ...
        __doc__="""This class implements a plain hexadecimal %s hash, and follows the :ref:`***REMOVED***-hash-api`.
