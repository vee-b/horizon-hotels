...
def _raw_md5_crypt(pwd, salt, use_apr=False):
    ...
    # add null chars & first char of ***REMOVED***
...
class md5_crypt(uh.HasManyBackends, _MD5_Common):
    """This class implements the MD5-Crypt ***REMOVED*** hash, and follows the :ref:`***REMOVED***-hash-api`.
...
class apr_md5_crypt(_MD5_Common):
    """This class implements the Apr-MD5-Crypt ***REMOVED*** hash, and follows the :ref:`***REMOVED***-hash-api`.
