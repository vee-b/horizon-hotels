...
class AppWalletTest(TestCase):
    ...
    def test_decrypt_key(self):
        ...
        # different sized key, ***REMOVED***, and cost
        ...
        # wrong ***REMOVED*** should silently result in wrong key
        temp = CIPHER1.copy()
        temp.update(t='2')
...
class TotpTest(TestCase):
    ...
    vectors = [
        ...
        # generated at http://blog.tinisles.com/2011/10/google-authenticator-one-time-***REMOVED***-algorithm-in-javascript
