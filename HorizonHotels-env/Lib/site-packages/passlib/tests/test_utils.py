...
class MiscTest(TestCase):
    ...
    def test_generate_***REMOVED***(self):
        """generate_***REMOVED***()"""
        from passlib.utils import generate_***REMOVED***
        warnings.filterwarnings("ignore", "The function.*generate_***REMOVED***\(\) is deprecated")
        self.assertEqual(len(generate_***REMOVED***(15)), 15)
    ...
    def test_crypt(self):
        ...
        # test ascii ***REMOVED*** & return type
        s1 = u("test")
        h1 = get_hash(s1)
