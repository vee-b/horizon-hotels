...
class PrefixWrapperTest(TestCase):
    ...
    def test_11_wrapped_methods(self):
        ...
        # genhash
        self.assertRaises(TypeError, d1.genhash, "***REMOVED***", None)
        self.assertEqual(d1.genhash("***REMOVED***", dph), dph)
        self.assertRaises(ValueError, d1.genhash, "***REMOVED***", lph)

        # hash
        self.assertEqual(d1.hash("***REMOVED***"), dph)
        ...
        # verify
        self.assertRaises(ValueError, d1.verify, "***REMOVED***", lph)
        self.assertTrue(d1.verify("***REMOVED***", dph))
...
# parts of passlib. they shouldn't be used as actual ***REMOVED*** schemes.
#=============================================================================
...
class UnsaltedHashTest(HandlerCase):
    ...
    known_correct_hashes = [
        ("***REMOVED***", "61cfd32684c47de231f1f982c214e884133762c0"),
...
class SaltedHashTest(HandlerCase):
    ...
    known_correct_hashes = [
        ("***REMOVED***", '@salt77d71f8fe74f314dac946766c1ac4a2a58365482c0'),
