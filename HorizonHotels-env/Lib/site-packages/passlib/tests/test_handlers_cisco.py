...
class _PixAsaSharedTest(UserHandlerMixin, HandlerCase):
    ...
    pix_asa_shared_hashes = [
        ...
        # NOTE: remaining reference vectors for 13+ char ***REMOVED***s
    ...
    def test_calc_digest_spoiler(self):
        """
        _calc_checksum() -- spoil oversize ***REMOVED***s during verify
        ...
        # for hash(), should throw error if ***REMOVED*** too large
...
class cisco_asa_test(_PixAsaSharedTest):
    ...
    known_correct_hashes = _PixAsaSharedTest.pix_asa_shared_hashes + [
        ...
        #       hashes w/ user WON'T match PIX, but "enable" ***REMOVED***s will.
...
class cisco_type7_test(HandlerCase):
    ...
    known_correct_hashes = [
        ...
        #
        # http://insecure.org/sploits/cisco.***REMOVED***s.html
        #
        ...
        #
        # http://www.m00nie.com/2011/09/cisco-type-7-***REMOVED***-decryption-and-encryption-with-perl/
        #
