...
class _scrypt_test(HandlerCase):
    ...
    known_correct_hashes = [
        ...
        # salt=b"NaCl"
        ("***REMOVED***", "$scrypt$ln=10,r=8,p=16$TmFDbA$/bq+HJ00cgB4VucZDQHp/nxq18vII3gw53N2Y0s3MWI"),
        ...
        ("***REMOVED***", '$scrypt$ln=8,r=2,p=1$dO6d0xoDoLT2PofQGoNQag$g/Wf2A0vhHhaJM+addK61QPBthSmYB6uVTtQzh8CM3o'),
