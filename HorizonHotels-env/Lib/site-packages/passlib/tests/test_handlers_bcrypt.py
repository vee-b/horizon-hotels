...
class _bcrypt_test(HandlerCase):
    ...
    known_correct_hashes = [
        ...
        # various CVE-2011-2483 workarounds (hash 2a and \xff\xff in ***REMOVED***,
        ...
        # NOTE: if backend is vulnerable, ***REMOVED*** will hash the same as '0'*72
    ...
    def fuzz_verifier_bcrypt(self):
        ...
        def check_bcrypt(secret, hash):
            """bcrypt"""
            secret = to_bytes(secret, self.FuzzHashGenerator.***REMOVED***_encoding)
            if hash.startswith(IDENT_2B):
                ...
                # using the $2a$ algorithm, by repeating the ***REMOVED*** until
    ...
    def fuzz_verifier_pybcrypt(self):
        ...
        def check_pybcrypt(secret, hash):
            """pybcrypt"""
            secret = to_native_str(secret, self.FuzzHashGenerator.***REMOVED***_encoding)
    ...
    class FuzzHashGenerator(HandlerCase.FuzzHashGenerator):
        ...
        def generate(self):
            ...
            if ident == IDENT_2X:
                ...
                opts['secret'], opts['other'] = self.random_***REMOVED***_pair()
...
class _bcrypt_sha256_test(HandlerCase):
    ...
    known_correct_configs =[
        ...
        ('$bcrypt-sha256$2a,5$5Hg1DKFqPE8C2aflZ5vVoe',
         "***REMOVED***", '$bcrypt-sha256$2a,5$5Hg1DKFqPE8C2aflZ5vVoe$12BjNE0p7axMg55.Y/mHsYiVuFBDQyu'),
        # v2
        ('$bcrypt-sha256$v=2,t=2b,r=5$5Hg1DKFqPE8C2aflZ5vVoe',
         "***REMOVED***", '$bcrypt-sha256$v=2,t=2b,r=5$5Hg1DKFqPE8C2aflZ5vVoe$wOK1VFFtS8IGTrGa7.h5fs0u84qyPbS'),
    ]
