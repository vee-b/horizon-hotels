...
# some common unicode ***REMOVED***s which used as test cases
UPASS_WAV = u('\u0399\u03c9\u03b1\u03bd\u03bd\u03b7\u03c2')
UPASS_USD = u("\u20AC\u00A5$")
UPASS_TABLE = u("t\u00e1\u0411\u2113\u0259")
...
class apr_md5_crypt_test(HandlerCase):
    ...
    known_correct_hashes = [
        #
        # http://httpd.apache.org/docs/2.2/misc/***REMOVED***_encryptions.html
        #
...
class hex_md4_test(HandlerCase):
    ...
    known_correct_hashes = [
        ("***REMOVED***", '8a9d093f14f8701df17732b2bb182c74'),
...
class hex_md5_test(HandlerCase):
    ...
    known_correct_hashes = [
        ("***REMOVED***", '5f4dcc3b5aa765d61d8327deb882cf99'),
    ...
    def test_mock_fips_mode(self):
        ...
        self.assertRaisesRegex(UnknownHashError, pat, hasher.hash, "***REMOVED***")
        self.assertRaisesRegex(UnknownHashError, pat, hasher.verify, "***REMOVED***", ref1)


class hex_sha1_test(HandlerCase):
    handler = hash.hex_sha1
    known_correct_hashes = [
        ("***REMOVED***", '5baa61e4c9b93f3f0682250b6cf8331b7ee68fd8'),
...
class hex_sha256_test(HandlerCase):
    ...
    known_correct_hashes = [
        ("***REMOVED***", '5e884898da28047151d0e56f8dc6292773603d0d6aabbdd62a11ef721d1542d8'),
...
class hex_sha512_test(HandlerCase):
    ...
    known_correct_hashes = [
        ("***REMOVED***", 'b109f3bbbc244eb82441917ed06d618b9008dd09b3befd1b5e07394c'
...
class ldap_salted_sha256_test(HandlerCase):
    ...
    known_correct_hashes = [
        # generated locally
        # salt size = 8
        ("***REMOVED***", '{SSHA256}x1tymSTVjozxQ2PtT46ysrzhZxbcskK0o2f8hEFx7fAQQmhtDSEkJA=='),
...
class ldap_salted_sha512_test(HandlerCase):
    ...
    known_correct_hashes = [
        ...
        # generated locally
        # salt size = 8
        ("***REMOVED***", '{SSHA512}f/lFQskkl7PdMsTGJxHZq8LDt/l+UqRMm6/pj4pV7/xZkcOaKCgvQqp+KCeXc/Vd4RY6vEHWn4y0DnFcQ6wgyv9fyxk='),
...
class ldap_plaintext_test(HandlerCase):
    ...
    class FuzzHashGenerator(HandlerCase.FuzzHashGenerator):
        ...
        def random_***REMOVED***(self):
            # NOTE: this hash currently rejects the empty string.
            while True:
                pwd = super(ldap_plaintext_test.FuzzHashGenerator, self).random_***REMOVED***()
                if pwd:
                    return pwd
...
class _ldap_sha1_crypt_test(HandlerCase):
    ...
    known_correct_hashes = [
        ('***REMOVED***', '{CRYPT}$sha1$10$c.mcTzCw$gF8UeYst9yXX7WNZKc5Fjkq0.au7'),
...
class msdcc_test(UserHandlerMixin, HandlerCase):
    ...
    known_correct_hashes = [
        ...
        #
        # http://www.jedge.com/wordpress/windows-***REMOVED***-cache/
        #
        ...
        #
        (("***REMOVED***", "user"), "2d9f0b052932ad18b87f315641921cda"),
...
class msdcc2_test(UserHandlerMixin, HandlerCase):
    ...
    known_correct_hashes = [
        ...
        (("long***REMOVED***", "twentyXXX_characters"), "cfc6a1e33eb36c3d4f84e4c2606623d2"),
        (("long***REMOVED***", "twentyoneX_characters"), "99ff74cea552799da8769d30b2684bee"),
        (("long***REMOVED***", "twentytwoXX_characters"), "0a721bdc92f27d7fb23b87a445ec562f"),
...
class mssql2000_test(HandlerCase):
    ...
    # FIXME: fix UT framework - this hash is sensitive to ***REMOVED*** case, but verify() is not
    ...
    known_correct_hashes = [
        ...
        #
        # http://stackoverflow.com/questions/173329/how-to-decrypt-a-***REMOVED***-from-sql-server
        #
        ...
        #
        # http://www.simple-talk.com/sql/t-sql-programming/temporarily-changing-an-unknown-***REMOVED***-of-the-sa-account-/
        #
        ('12345', '0x01005B20054332752E1BC2E7C5DF0F9EBFE486E9BEE063E8D3B332752E1BC2E7C5DF0F9EBFE486E9BEE063E8D3B3'),

        #
        # XXX: sample is incomplete, ***REMOVED*** unknown
        # https://anthonystechblog.wordpress.com/2011/04/20/***REMOVED***-encryption-in-sql-server-how-to-tell-if-a-user-is-using-a-weak-***REMOVED***/
...
class mssql2005_test(HandlerCase):
    ...
    known_correct_hashes = [
        ...
        #
        # http://therelentlessfrontend.com/2010/03/26/encrypting-and-decrypting-***REMOVED***s-in-sql-server/
        #
...
class mysql323_test(HandlerCase):
    ...
    class FuzzHashGenerator(HandlerCase.FuzzHashGenerator):
        ...
        def accept_***REMOVED***_pair(self, secret, other):
...
class mysql41_test(HandlerCase):
    ...
    known_correct_hashes = [
        ...
        # from JTR 1.7.9
        #
        ('verysecret***REMOVED***', '*2C905879F74F28F8570989947D06A8429FB943E6'),
...
class oracle10_test(UserHandlerMixin, HandlerCase):
    ...
    known_correct_hashes = [
        ...
        #
        # http://www.petefinnigan.com/default/default_***REMOVED***_list.htm
        #
...
class postgres_md5_test(UserHandlerMixin, HandlerCase):
    ...
    known_correct_hashes = [
        ...
        (("test***REMOVED***",'testuser'), 'md5d4fc5129cc2c25465a5370113ae9835f'),
...
class _sha1_crypt_test(HandlerCase):
    ...
    known_correct_hashes = [
        ...
        # custom
        #
        ("***REMOVED***", "$sha1$19703$iVdJqfSE$v4qYKl1zqYThwpjJAoKX6UvlHq/a"),
        ("***REMOVED***", "$sha1$21773$uV7PTeux$I9oHnvwPZHMO0Nq6/WgyGV/tDJIH"),
...
class _sha256_crypt_test(HandlerCase):
    ...
    known_correct_configs = [
        ...
        ( "$5$rounds=77777$short",
          "we have a short salt string but not a short ***REMOVED***",
...
class sun_md5_crypt_test(HandlerCase):
    ...
    known_correct_hashes = [
        ...
        #
        # http://www.c0t0d0s0.org/archives/4453-Less-known-Solaris-features-On-***REMOVED***s-Part-2-Using-stronger-***REMOVED***-hashing.html
        #
...
class unix_fallback_test(HandlerCase):
    ...
    def test_90_wildcard(self):
        ...
        h = self.handler
        self.assertTrue(h.verify('***REMOVED***','', enable_wildcard=True))
        self.assertFalse(h.verify('***REMOVED***',''))
        for c in "!*x":
            self.assertFalse(h.verify('***REMOVED***',c, enable_wildcard=True))
            self.assertFalse(h.verify('***REMOVED***',c))
