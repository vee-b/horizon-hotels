...
class Pbkdf1_Test(TestCase):
    ...
    pbkdf1_tests = [
        # (***REMOVED***, salt, rounds, keylen, hash, result)

        #
        # from http://www.di-mgt.com.au/cryptoKDFs.html
        #
        (b'***REMOVED***', hb('78578E5A5D63CB06'), 1000, 16, 'sha1', hb('dc19847e05c64d2faf10ebfb4a3d2a20')),

        #
        # custom
        #
        (b'***REMOVED***', b'salt', 1000, 0, 'md5',    b''),
        (b'***REMOVED***', b'salt', 1000, 1, 'md5',    hb('84')),
        (b'***REMOVED***', b'salt', 1000, 8, 'md5',    hb('8475c6a8531a5d27')),
        (b'***REMOVED***', b'salt', 1000, 16, 'md5', hb('8475c6a8531a5d27e386cd496457812c')),
        (b'***REMOVED***', b'salt', 1000, None, 'md5', hb('8475c6a8531a5d27e386cd496457812c')),
        (b'***REMOVED***', b'salt', 1000, None, 'sha1', hb('4a8fd48e426ed081b535be5769892fa396293efb')),
    ]
    if not JYTHON: # FIXME: find out why not jython, or reenable this.
        pbkdf1_tests.append(
            (b'***REMOVED***', b'salt', 1000, None, 'md4', hb('f7f2e91100a8f96190f2dd177cb26453'))
        )
...
class Pbkdf2Test(TestCase):
    ...
    def test_border(self):
        """test border cases"""
        def helper(secret=b'***REMOVED***', salt=b'salt', rounds=1, keylen=None, digest="sha1"):
