...
class pbkdf2_sha1_test(HandlerCase):
    ...
    known_correct_hashes = [
        ("***REMOVED***", '$pbkdf2$1212$OB.dtnSEXZK8U5cgxU/GYQ$y5LKPOplRmok7CZp/aqVDVg8zGI'),
        (UPASS_WAV,
...
class cta_pbkdf2_sha1_test(HandlerCase):
    ...
    known_correct_hashes = [
        ...
        # custom
        #
        ("***REMOVED***", "$p5k2$1$$h1TDLGSw9ST8UMAPeIE13i0t12c="),
        (UPASS_WAV,
...
class scram_test(HandlerCase):
    ...
    known_correct_hashes = [
        ...
        # test unicode ***REMOVED***s & saslprep (all the ***REMOVED***s below
    ...
    def test_93_derive_digest(self):
        ...
        # check various encodings of ***REMOVED*** work.
        s1 = b'\x01\x02\x03'
    ...
    def test_96_full_verify(self):
        ...
        # catch hash containing digests belonging to diff ***REMOVED***s.
