...
class PasswordHash(object):
    """This class describes an abstract interface which all ***REMOVED*** hashes
    ...
    #: depend on the provided ***REMOVED***.
    is_disabled = False
    ...
    #: If True, .verify() should reject secrets larger than max_***REMOVED***_size.
